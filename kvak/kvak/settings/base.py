"""
Django settings for kvak project.
...
WSGI_APPLICATION = "kvak.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DJANGO_DATABASE_NAME", "kvak"),
        "USER": os.getenv("DJANGO_DATABASE_USERNAME", "kvak"),
