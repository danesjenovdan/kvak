...
ALLOWED_HOSTS = ["kvak.lb.djnd.si"]
CSRF_TRUSTED_ORIGINS = ["https://kvak.lb.djnd.si"]
WAGTAILADMIN_BASE_URL = "https://kvak.lb.djnd.si"
...
if os.getenv("DJANGO_ENABLE_S3", False):
    ...
    AWS_LOCATION = os.getenv("DJANGO_AWS_LOCATION", "kvak")
